...
export const QuoteIcon: React.FC<IconProps> = (props) => (
    <svg 
        ...
        {...props}
    >
        <path d="M3 21c3 0 7-1 7-8V5c0-1.25-.756-2.017-2-2H4c-1.25 0-2 .75-2 2v6c0 7 4 8 8 8Z"></path>
        <path d="M14 21c3 0 7-1 7-8V5c0-1.25-.75-2.017-2-2h-4c-1.25 0-2 .75-2 2v6c0 7 4 8 8 8Z"></path>
    </svg>
);
...
export const SettingsIcon: React.FC<IconProps> = (props) => (
  ...
  >
    ...
    <path d="M12 1v6m0 6v6m-8-7h6m6 0h6m-13 7l4-4m6 6l-4-4m-4-8l4 4m6-6l-4 4"></path>
  </svg>
);